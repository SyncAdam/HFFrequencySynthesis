-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\SignalGenerator\RADIX2FFT_bitNatural.vhd
...
-- Source Path: SignalGenerator/IFFT/RADIX2FFT_bitNatural
-- Hierarchy Level: 2
-- Model version: 2.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF RADIX2FFT_bitNatural IS
  ...
  SIGNAL memOut_im_signed                 : signed(40 DOWNTO 0);  -- sfix41_En17
  SIGNAL memOut_re                        : std_logic_vector(40 DOWNTO 0);  -- ufix41
  SIGNAL memOut_re_signed                 : signed(40 DOWNTO 0);  -- sfix41_En17
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(40 DOWNTO 0);  -- sfix41_En17
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(40 DOWNTO 0);  -- sfix41_En17
  ...
  SIGNAL dout_re1_tmp                     : signed(40 DOWNTO 0);  -- sfix41_En17
  SIGNAL dout_im1_tmp                     : signed(40 DOWNTO 0);  -- sfix41_En17
