-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\SignalGenerator\RADIX22FFT_SDF1_3.vhd
...
-- Source Path: SignalGenerator/IFFT/RADIX22FFT_SDF1_3
-- Hierarchy Level: 2
-- Model version: 2.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_3 IS
  ...
  COMPONENT SDFCommutator3
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          din_3_vld_dly                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En17
          xf_im                           :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En17
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En17
          dinXTwdlf_im                    :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En17
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En17
          btf1_im                         :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En17
          btf2_re                         :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En17
          btf2_im                         :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En17
          btf_vld                         :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35_En17
          wrData_im                       :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35_En17
  ...
  -- Signals
  SIGNAL din_3_1_re_dly_signed            : signed(33 DOWNTO 0);  -- sfix34_En17
  SIGNAL din_re                           : signed(34 DOWNTO 0);  -- sfix35_En17
  SIGNAL din_3_1_im_dly_signed            : signed(33 DOWNTO 0);  -- sfix34_En17
  SIGNAL din_im                           : signed(34 DOWNTO 0);  -- sfix35_En17
  ...
  SIGNAL dinXTwdl_re_signed               : signed(34 DOWNTO 0);  -- sfix35_En17
  SIGNAL dinXTwdl_im_signed               : signed(34 DOWNTO 0);  -- sfix35_En17
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(34 DOWNTO 0);  -- sfix35_En17
  SIGNAL btf2_re                          : signed(34 DOWNTO 0);  -- sfix35_En17
  SIGNAL btf1_im                          : signed(34 DOWNTO 0);  -- sfix35_En17
  SIGNAL btf1_re                          : signed(34 DOWNTO 0);  -- sfix35_En17
  SIGNAL dinXTwdlf_im                     : signed(34 DOWNTO 0);  -- sfix35_En17
  SIGNAL dinXTwdlf_re                     : signed(34 DOWNTO 0);  -- sfix35_En17
  SIGNAL xf_im                            : signed(34 DOWNTO 0);  -- sfix35_En17
  ...
  SIGNAL Radix22ButterflyG1_btf1_re_reg_next : signed(35 DOWNTO 0);  -- sfix36_En17
  SIGNAL Radix22ButterflyG1_btf1_im_reg_next : signed(35 DOWNTO 0);  -- sfix36_En17
  SIGNAL Radix22ButterflyG1_btf2_re_reg_next : signed(35 DOWNTO 0);  -- sfix36_En17
  SIGNAL Radix22ButterflyG1_btf2_im_reg_next : signed(35 DOWNTO 0);  -- sfix36_En17
  SIGNAL Radix22ButterflyG1_add_cast      : signed(35 DOWNTO 0);  -- sfix36_En17
  SIGNAL Radix22ButterflyG1_add_cast_1    : signed(35 DOWNTO 0);  -- sfix36_En17
  SIGNAL Radix22ButterflyG1_sub_cast      : signed(35 DOWNTO 0);  -- sfix36_En17
  SIGNAL Radix22ButterflyG1_sub_cast_1    : signed(35 DOWNTO 0);  -- sfix36_En17
  SIGNAL Radix22ButterflyG1_add_cast_2    : signed(35 DOWNTO 0);  -- sfix36_En17
  SIGNAL Radix22ButterflyG1_add_cast_3    : signed(35 DOWNTO 0);  -- sfix36_En17
  SIGNAL Radix22ButterflyG1_sub_cast_2    : signed(35 DOWNTO 0);  -- sfix36_En17
  SIGNAL Radix22ButterflyG1_sub_cast_3    : signed(35 DOWNTO 0);  -- sfix36_En17
  SIGNAL xf_re                            : signed(34 DOWNTO 0);  -- sfix35_En17
...
BEGIN
  u_MUL3 : Complex3Multiply
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_re => std_logic_vector(din_re),  -- sfix35_En17
              din_im => std_logic_vector(din_im),  -- sfix35_En17
              din_3_vld_dly => din_3_vld_dly,
              twdl_3_1_re => twdl_3_1_re,  -- sfix32_En30
              twdl_3_1_im => twdl_3_1_im,  -- sfix32_En30
              dinXTwdl_re => dinXTwdl_re,  -- sfix35_En17
              dinXTwdl_im => dinXTwdl_im,  -- sfix35_En17
  ...
  u_SDFCOMMUTATOR_3 : SDFCommutator3
    PORT MAP( clk => clk,
              ...
              enb => enb,
              din_3_vld_dly => din_3_vld_dly,
              xf_re => std_logic_vector(xf_re),  -- sfix35_En17
              xf_im => std_logic_vector(xf_im),  -- sfix35_En17
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix35_En17
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix35_En17
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix35_En17
              btf1_im => std_logic_vector(btf1_im),  -- sfix35_En17
              btf2_re => std_logic_vector(btf2_re),  -- sfix35_En17
              btf2_im => std_logic_vector(btf2_im),  -- sfix35_En17
              btf_vld => btf_vld,
              wrData_re => wrData_re,  -- sfix35_En17
              wrData_im => wrData_im,  -- sfix35_En17
              wrAddr => wrAddr,  -- ufix6
              wrEnb => wrEnb,
              dout_3_1_re => dout_3_1_re_tmp,  -- sfix35_En17
              dout_3_1_im => dout_3_1_im_tmp,  -- sfix35_En17
