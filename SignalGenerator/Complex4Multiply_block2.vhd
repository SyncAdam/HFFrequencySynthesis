-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\SignalGenerator\Complex4Multiply_block2.vhd
-- Created: 2026-05-02 13:39:59
-- 
...
-- Source Path: SignalGenerator/IFFT/RADIX22FFT_SDF1_9/Complex4Multiply
-- Hierarchy Level: 3
-- Model version: 2.2
-- 
-- -------------------------------------------------------------
...
ENTITY Complex4Multiply_block2 IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb                               :   IN    std_logic;
        din_re                            :   IN    std_logic_vector(40 DOWNTO 0);  -- sfix41_En21
        din_im                            :   IN    std_logic_vector(40 DOWNTO 0);  -- sfix41_En21
        ...
        dinXTwdl_re                       :   OUT   std_logic_vector(40 DOWNTO 0);  -- sfix41_En21
        dinXTwdl_im                       :   OUT   std_logic_vector(40 DOWNTO 0);  -- sfix41_En21
...
ARCHITECTURE rtl OF Complex4Multiply_block2 IS
  ...
  -- Signals
  SIGNAL din_re_signed                    : signed(40 DOWNTO 0);  -- sfix41_En21
  SIGNAL din_re_reg                       : signed(40 DOWNTO 0);  -- sfix41_En21
  SIGNAL din_im_signed                    : signed(40 DOWNTO 0);  -- sfix41_En21
  SIGNAL din_im_reg                       : signed(40 DOWNTO 0);  -- sfix41_En21
  ...
  SIGNAL prod1_re                         : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73_En51
  SIGNAL prod1_im                         : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73_En51
  SIGNAL prod2_re                         : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73_En51
  SIGNAL prod2_im                         : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73_En51
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(73 DOWNTO 0);  -- sfix74_En51
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(73 DOWNTO 0);  -- sfix74_En51
  SIGNAL Complex4Add_sub_cast             : signed(73 DOWNTO 0);  -- sfix74_En51
  SIGNAL Complex4Add_sub_cast_1           : signed(73 DOWNTO 0);  -- sfix74_En51
  SIGNAL Complex4Add_add_cast             : signed(73 DOWNTO 0);  -- sfix74_En51
  SIGNAL Complex4Add_add_cast_1           : signed(73 DOWNTO 0);  -- sfix74_En51
  SIGNAL mulResFP_re                      : signed(73 DOWNTO 0);  -- sfix74_En51
  SIGNAL mulResFP_im                      : signed(73 DOWNTO 0);  -- sfix74_En51
  SIGNAL dinXTwdl_9_vld_1                 : std_logic;
  SIGNAL dinXTwdl_re_tmp                  : signed(40 DOWNTO 0);  -- sfix41_En21
  SIGNAL dinXTwdl_im_tmp                  : signed(40 DOWNTO 0);  -- sfix41_En21
...
BEGIN
  ...
  dinXTwdl_re_tmp <= mulResFP_re(70 DOWNTO 30) + ('0' & mulResFP_re(29));

  dinXTwdl_re <= std_logic_vector(dinXTwdl_re_tmp);

  dinXTwdl_im_tmp <= mulResFP_im(70 DOWNTO 30) + ('0' & mulResFP_im(29));
