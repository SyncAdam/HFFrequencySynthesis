-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\SignalGenerator\Complex4Multiply_block.vhd
...
-- Source Path: SignalGenerator/IFFT/RADIX22FFT_SDF1_5/Complex4Multiply
-- Hierarchy Level: 3
-- Model version: 2.2
-- 
-- -------------------------------------------------------------
...
ENTITY Complex4Multiply_block IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb                               :   IN    std_logic;
        din_re                            :   IN    std_logic_vector(36 DOWNTO 0);  -- sfix37_En21
        din_im                            :   IN    std_logic_vector(36 DOWNTO 0);  -- sfix37_En21
        ...
        dinXTwdl_re                       :   OUT   std_logic_vector(36 DOWNTO 0);  -- sfix37_En21
        dinXTwdl_im                       :   OUT   std_logic_vector(36 DOWNTO 0);  -- sfix37_En21
...
ARCHITECTURE rtl OF Complex4Multiply_block IS
  ...
  -- Signals
  SIGNAL din_re_signed                    : signed(36 DOWNTO 0);  -- sfix37_En21
  SIGNAL din_re_reg                       : signed(36 DOWNTO 0);  -- sfix37_En21
  SIGNAL din_im_signed                    : signed(36 DOWNTO 0);  -- sfix37_En21
  SIGNAL din_im_reg                       : signed(36 DOWNTO 0);  -- sfix37_En21
  ...
  SIGNAL prod1_re                         : signed(68 DOWNTO 0) := to_signed(0, 69);  -- sfix69_En51
  SIGNAL prod1_im                         : signed(68 DOWNTO 0) := to_signed(0, 69);  -- sfix69_En51
  SIGNAL prod2_re                         : signed(68 DOWNTO 0) := to_signed(0, 69);  -- sfix69_En51
  SIGNAL prod2_im                         : signed(68 DOWNTO 0) := to_signed(0, 69);  -- sfix69_En51
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(69 DOWNTO 0);  -- sfix70_En51
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(69 DOWNTO 0);  -- sfix70_En51
  SIGNAL Complex4Add_sub_cast             : signed(69 DOWNTO 0);  -- sfix70_En51
  SIGNAL Complex4Add_sub_cast_1           : signed(69 DOWNTO 0);  -- sfix70_En51
  SIGNAL Complex4Add_add_cast             : signed(69 DOWNTO 0);  -- sfix70_En51
  SIGNAL Complex4Add_add_cast_1           : signed(69 DOWNTO 0);  -- sfix70_En51
  SIGNAL mulResFP_re                      : signed(69 DOWNTO 0);  -- sfix70_En51
  SIGNAL mulResFP_im                      : signed(69 DOWNTO 0);  -- sfix70_En51
  SIGNAL dinXTwdl_5_1_vld_1               : std_logic;
  SIGNAL dinXTwdl_re_tmp                  : signed(36 DOWNTO 0);  -- sfix37_En21
  SIGNAL dinXTwdl_im_tmp                  : signed(36 DOWNTO 0);  -- sfix37_En21
...
BEGIN
  ...
  dinXTwdl_re_tmp <= mulResFP_re(66 DOWNTO 30) + ('0' & mulResFP_re(29));

  dinXTwdl_re <= std_logic_vector(dinXTwdl_re_tmp);

  dinXTwdl_im_tmp <= mulResFP_im(66 DOWNTO 30) + ('0' & mulResFP_im(29));
