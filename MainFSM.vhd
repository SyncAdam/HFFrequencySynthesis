...
begin
	...
	configurator: entity work.ConfigureADC(basic)
						port map(writeconfig, configok, sdenb, sclk, sdio, inputClock, ClkOUT, writeConfigReceived, stateRegOut, nextStateRegOut, resetn, discardBuffer, WrReEn, WrReStatus);
