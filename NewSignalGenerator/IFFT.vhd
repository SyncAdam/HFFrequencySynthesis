-- -------------------------------------------------------------
-- 
-- File Name: /MATLAB Drive/HDLGen/NewSignalGenerator/IFFT.vhd
...
ARCHITECTURE rtl OF IFFT IS
  ...
  COMPONENT TWDLROM_9_1
    PORT( clk                             :   IN    std_logic;
          ...
          twdl_9_re                       :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          twdl_9_im                       :   OUT   std_logic_vector(31 DOWNTO 0)  -- sfix32_En30
          );
  END COMPONENT;
  ...
  COMPONENT RADIX22FFT_SDF1_9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_9_re_dly                    :   IN    std_logic_vector(39 DOWNTO 0);  -- sfix40_En20
          din_9_im_dly                    :   IN    std_logic_vector(39 DOWNTO 0);  -- sfix40_En20
          ...
          dout_9_re                       :   OUT   std_logic_vector(40 DOWNTO 0);  -- sfix41_En20
          dout_9_im                       :   OUT   std_logic_vector(40 DOWNTO 0);  -- sfix41_En20
  ...
  COMPONENT RADIX2FFT_bitNatural
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_9_re                       :   IN    std_logic_vector(40 DOWNTO 0);  -- sfix41_En20
          dout_9_im                       :   IN    std_logic_vector(40 DOWNTO 0);  -- sfix41_En20
          dout_9_vld                      :   IN    std_logic;
          dout_re1                        :   OUT   std_logic_vector(40 DOWNTO 0);  -- sfix41_En20
          dout_im1                        :   OUT   std_logic_vector(40 DOWNTO 0)  -- sfix41_En20
          );
  END COMPONENT;
  ...
  SIGNAL din_9_re_dly                     : signed(39 DOWNTO 0);  -- sfix40_En20
  SIGNAL intdelay_reg_13                  : vector_of_signed40(0 TO 2);  -- sfix40 [3]
  SIGNAL din_9_im_dly                     : signed(39 DOWNTO 0);  -- sfix40_En20
  SIGNAL intdelay_reg_14                  : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
  SIGNAL din_9_vld_dly                    : std_logic;
  SIGNAL twdl_9_re                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL twdl_9_im                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL dout_9_re                        : std_logic_vector(40 DOWNTO 0);  -- ufix41
  SIGNAL dout_9_im                        : std_logic_vector(40 DOWNTO 0);  -- ufix41
  SIGNAL dout_9_vld                       : std_logic;
  SIGNAL dout_re1                         : std_logic_vector(40 DOWNTO 0);  -- ufix41
  SIGNAL dout_im1                         : std_logic_vector(40 DOWNTO 0);  -- ufix41
...
BEGIN
  ...
  u_twdlROM_9 : TWDLROM_9_1
    PORT MAP( clk => clk,
              ...
              enb => enb,
              dout_8_1_vld => dout_8_1_vld,
              twdl_9_re => twdl_9_re,  -- sfix32_En30
              twdl_9_im => twdl_9_im  -- sfix32_En30
              );
  ...
  u_RADIX2 : RADIX22FFT_SDF1_9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_9_re_dly => std_logic_vector(din_9_re_dly),  -- sfix40_En20
              din_9_im_dly => std_logic_vector(din_9_im_dly),  -- sfix40_En20
              ...
              twdl_9_im => twdl_9_im,  -- sfix32_En30
              proc_9_enb => proc_9_enb,
              dout_9_re => dout_9_re,  -- sfix41_En20
              dout_9_im => dout_9_im,  -- sfix41_En20
  ...
  u_NaturalOrder_Stage : RADIX2FFT_bitNatural
    PORT MAP( clk => clk,
              ...
              dout_9_im => dout_9_im,  -- sfix41_En20
              dout_9_vld => dout_9_vld,
              dout_re1 => dout_re1,  -- sfix41_En20
              dout_im1 => dout_im1  -- sfix41_En20
              );
