...
module  DataClock_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //DataClock_altclkctrl_0_sub
...
module  DataClock_altclkctrl_0  (
    ...
    DataClock_altclkctrl_0_sub  DataClock_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
