...
# ACDS 18.1 625 win32 2026.07.03.12:19:30
...
# ----------------------------------------
# If NewPLL is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/NewPLL.vo"
fi
