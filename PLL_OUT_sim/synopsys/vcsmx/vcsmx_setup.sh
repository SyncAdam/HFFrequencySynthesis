...
# ACDS 18.1 625 win32 2026.05.05.11:53:05
...
# ----------------------------------------
# If PLL_OUT is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_OUT.vho"
fi
