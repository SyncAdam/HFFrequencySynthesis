...
ARCHITECTURE rtl OF IFFT IS
  ...
  COMPONENT RADIX22FFT_SDF1_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_1_1_re_dly                  :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32
          din_1_1_im_dly                  :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32
          din_1_vld_dly                   :   IN    std_logic;
          rd_1_Addr                       :   IN    std_logic_vector(7 DOWNTO 0);  -- ufix8
          rd_1_Enb                        :   IN    std_logic;
          proc_1_enb                      :   IN    std_logic;
          dout_1_1_re                     :   OUT   std_logic_vector(32 DOWNTO 0);  -- sfix33
          dout_1_1_im                     :   OUT   std_logic_vector(32 DOWNTO 0);  -- sfix33
  ...
  COMPONENT RADIX22FFT_SDF2_2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_1_1_re                     :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          dout_1_1_im                     :   IN    std_logic_vector(32 DOWNTO 0);  -- sfix33
          dout_1_1_vld                    :   IN    std_logic;
          rd_2_Addr                       :   IN    std_logic_vector(6 DOWNTO 0);  -- ufix7
          rd_2_Enb                        :   IN    std_logic;
          proc_2_enb                      :   IN    std_logic;
          multiply_2_J                    :   IN    std_logic;
          dout_2_1_re                     :   OUT   std_logic_vector(33 DOWNTO 0);  -- sfix34
          dout_2_1_im                     :   OUT   std_logic_vector(33 DOWNTO 0);  -- sfix34
  ...
  COMPONENT RADIX22FFT_SDF1_3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_3_1_re_dly                  :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34
          din_3_1_im_dly                  :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34
          ...
          dout_3_1_re                     :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35
          dout_3_1_im                     :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35
  ...
  COMPONENT RADIX22FFT_SDF2_4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_3_1_re                     :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35
          dout_3_1_im                     :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35
          dout_3_1_vld                    :   IN    std_logic;
          rd_4_Addr                       :   IN    std_logic_vector(4 DOWNTO 0);  -- ufix5
          rd_4_Enb                        :   IN    std_logic;
          proc_4_enb                      :   IN    std_logic;
          multiply_4_J                    :   IN    std_logic;
          dout_4_1_re                     :   OUT   std_logic_vector(35 DOWNTO 0);  -- sfix36
          dout_4_1_im                     :   OUT   std_logic_vector(35 DOWNTO 0);  -- sfix36
  ...
  COMPONENT RADIX22FFT_SDF1_5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_5_1_re_dly                  :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36
          din_5_1_im_dly                  :   IN    std_logic_vector(35 DOWNTO 0);  -- sfix36
          ...
          dout_5_1_re                     :   OUT   std_logic_vector(36 DOWNTO 0);  -- sfix37
          dout_5_1_im                     :   OUT   std_logic_vector(36 DOWNTO 0);  -- sfix37
  ...
  COMPONENT RADIX22FFT_SDF2_6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_5_1_re                     :   IN    std_logic_vector(36 DOWNTO 0);  -- sfix37
          dout_5_1_im                     :   IN    std_logic_vector(36 DOWNTO 0);  -- sfix37
          dout_5_1_vld                    :   IN    std_logic;
          rd_6_Addr                       :   IN    std_logic_vector(2 DOWNTO 0);  -- ufix3
          rd_6_Enb                        :   IN    std_logic;
          proc_6_enb                      :   IN    std_logic;
          multiply_6_J                    :   IN    std_logic;
          dout_6_1_re                     :   OUT   std_logic_vector(37 DOWNTO 0);  -- sfix38
          dout_6_1_im                     :   OUT   std_logic_vector(37 DOWNTO 0);  -- sfix38
  ...
  COMPONENT RADIX22FFT_SDF1_7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_7_1_re_dly                  :   IN    std_logic_vector(37 DOWNTO 0);  -- sfix38
          din_7_1_im_dly                  :   IN    std_logic_vector(37 DOWNTO 0);  -- sfix38
          ...
          dout_7_1_re                     :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39
          dout_7_1_im                     :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39
  ...
  COMPONENT RADIX22FFT_SDF2_8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_7_1_re                     :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39
          dout_7_1_im                     :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39
          dout_7_1_vld                    :   IN    std_logic;
          rd_8_Addr                       :   IN    std_logic;  -- ufix1
          rd_8_Enb                        :   IN    std_logic;
          proc_8_enb                      :   IN    std_logic;
          multiply_8_J                    :   IN    std_logic;
          dout_8_1_re                     :   OUT   std_logic_vector(39 DOWNTO 0);  -- sfix40
          dout_8_1_im                     :   OUT   std_logic_vector(39 DOWNTO 0);  -- sfix40
  ...
  COMPONENT RADIX22FFT_SDF1_9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_9_re_dly                    :   IN    std_logic_vector(39 DOWNTO 0);  -- sfix40
          din_9_im_dly                    :   IN    std_logic_vector(39 DOWNTO 0);  -- sfix40
          ...
          dout_9_re                       :   OUT   std_logic_vector(40 DOWNTO 0);  -- sfix41
          dout_9_im                       :   OUT   std_logic_vector(40 DOWNTO 0);  -- sfix41
  ...
  COMPONENT RADIX2FFT_bitNatural
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_9_re                       :   IN    std_logic_vector(40 DOWNTO 0);  -- sfix41
          dout_9_im                       :   IN    std_logic_vector(40 DOWNTO 0);  -- sfix41
          dout_9_vld                      :   IN    std_logic;
          dout_re1                        :   OUT   std_logic_vector(40 DOWNTO 0);  -- sfix41
          dout_im1                        :   OUT   std_logic_vector(40 DOWNTO 0)  -- sfix41
          );
  END COMPONENT;
  ...
  -- Signals
  SIGNAL dataIn_re_signed                 : signed(31 DOWNTO 0);  -- int32
  SIGNAL dataIn_im_signed                 : signed(31 DOWNTO 0);  -- int32
  ...
  SIGNAL dout_2_1_re_signed               : signed(33 DOWNTO 0);  -- sfix34
  SIGNAL dout_2_1_im_signed               : signed(33 DOWNTO 0);  -- sfix34
  SIGNAL intdelay_reg_3                   : vector_of_signed34(0 TO 2);  -- sfix34 [3]
  SIGNAL din_3_1_re_dly                   : signed(33 DOWNTO 0);  -- sfix34
  SIGNAL intdelay_reg_4                   : vector_of_signed34(0 TO 2);  -- sfix34 [3]
  SIGNAL din_3_1_im_dly                   : signed(33 DOWNTO 0);  -- sfix34
  ...
  SIGNAL dout_4_1_re_signed               : signed(35 DOWNTO 0);  -- sfix36
  SIGNAL dout_4_1_im_signed               : signed(35 DOWNTO 0);  -- sfix36
  SIGNAL intdelay_reg_6                   : vector_of_signed36(0 TO 2);  -- sfix36 [3]
  SIGNAL din_5_1_re_dly                   : signed(35 DOWNTO 0);  -- sfix36
  SIGNAL intdelay_reg_7                   : vector_of_signed36(0 TO 2);  -- sfix36 [3]
  SIGNAL din_5_1_im_dly                   : signed(35 DOWNTO 0);  -- sfix36
  ...
  SIGNAL dout_6_1_re_signed               : signed(37 DOWNTO 0);  -- sfix38
  SIGNAL dout_6_1_im_signed               : signed(37 DOWNTO 0);  -- sfix38
  SIGNAL intdelay_reg_9                   : vector_of_signed38(0 TO 2);  -- sfix38 [3]
  SIGNAL din_7_1_re_dly                   : signed(37 DOWNTO 0);  -- sfix38
  SIGNAL intdelay_reg_10                  : vector_of_signed38(0 TO 2);  -- sfix38 [3]
  SIGNAL din_7_1_im_dly                   : signed(37 DOWNTO 0);  -- sfix38
  ...
  SIGNAL dout_8_1_re_signed               : signed(39 DOWNTO 0);  -- sfix40
  SIGNAL dout_8_1_im_signed               : signed(39 DOWNTO 0);  -- sfix40
  SIGNAL intdelay_reg_12                  : vector_of_signed40(0 TO 2);  -- sfix40 [3]
  SIGNAL din_9_re_dly                     : signed(39 DOWNTO 0);  -- sfix40
  SIGNAL intdelay_reg_13                  : vector_of_signed40(0 TO 2);  -- sfix40 [3]
  SIGNAL din_9_im_dly                     : signed(39 DOWNTO 0);  -- sfix40
...
BEGIN
  ...
  u_SDF1_1_1 : RADIX22FFT_SDF1_1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_1_1_re_dly => std_logic_vector(din_1_1_re_dly),  -- sfix32
              din_1_1_im_dly => std_logic_vector(din_1_1_im_dly),  -- sfix32
              din_1_vld_dly => din_1_vld_dly,
              rd_1_Addr => rd_1_Addr,  -- ufix8
              rd_1_Enb => rd_1_Enb,
              proc_1_enb => proc_1_enb,
              dout_1_1_re => dout_1_1_re,  -- sfix33
              dout_1_1_im => dout_1_1_im,  -- sfix33
  ...
  u_SDF2_2_1 : RADIX22FFT_SDF2_2
    PORT MAP( clk => clk,
              ...
              proc_2_enb => proc_2_enb,
              multiply_2_J => multiply_2_J,
              dout_2_1_re => dout_2_1_re,  -- sfix34
              dout_2_1_im => dout_2_1_im,  -- sfix34
  ...
  u_SDF1_3_1 : RADIX22FFT_SDF1_3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_3_1_re_dly => std_logic_vector(din_3_1_re_dly),  -- sfix34
              din_3_1_im_dly => std_logic_vector(din_3_1_im_dly),  -- sfix34
              ...
              twdl_3_1_im => twdl_3_1_im,  -- sfix32_En30
              proc_3_enb => proc_3_enb,
              dout_3_1_re => dout_3_1_re,  -- sfix35
              dout_3_1_im => dout_3_1_im,  -- sfix35
  ...
  u_SDF2_4_1 : RADIX22FFT_SDF2_4
    PORT MAP( clk => clk,
              ...
              proc_4_enb => proc_4_enb,
              multiply_4_J => multiply_4_J,
              dout_4_1_re => dout_4_1_re,  -- sfix36
              dout_4_1_im => dout_4_1_im,  -- sfix36
  ...
  u_SDF1_5_1 : RADIX22FFT_SDF1_5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_5_1_re_dly => std_logic_vector(din_5_1_re_dly),  -- sfix36
              din_5_1_im_dly => std_logic_vector(din_5_1_im_dly),  -- sfix36
              ...
              twdl_5_1_im => twdl_5_1_im,  -- sfix32_En30
              proc_5_enb => proc_5_enb,
              dout_5_1_re => dout_5_1_re,  -- sfix37
              dout_5_1_im => dout_5_1_im,  -- sfix37
  ...
  u_SDF2_6_1 : RADIX22FFT_SDF2_6
    PORT MAP( clk => clk,
              ...
              proc_6_enb => proc_6_enb,
              multiply_6_J => multiply_6_J,
              dout_6_1_re => dout_6_1_re,  -- sfix38
              dout_6_1_im => dout_6_1_im,  -- sfix38
  ...
  u_SDF1_7_1 : RADIX22FFT_SDF1_7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_7_1_re_dly => std_logic_vector(din_7_1_re_dly),  -- sfix38
              din_7_1_im_dly => std_logic_vector(din_7_1_im_dly),  -- sfix38
              ...
              twdl_7_1_im => twdl_7_1_im,  -- sfix32_En30
              proc_7_enb => proc_7_enb,
              dout_7_1_re => dout_7_1_re,  -- sfix39
              dout_7_1_im => dout_7_1_im,  -- sfix39
  ...
  u_SDF2_8_1 : RADIX22FFT_SDF2_8
    PORT MAP( clk => clk,
              ...
              proc_8_enb => proc_8_enb,
              multiply_8_J => multiply_8_J,
              dout_8_1_re => dout_8_1_re,  -- sfix40
              dout_8_1_im => dout_8_1_im,  -- sfix40
  ...
  u_RADIX2 : RADIX22FFT_SDF1_9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_9_re_dly => std_logic_vector(din_9_re_dly),  -- sfix40
              din_9_im_dly => std_logic_vector(din_9_im_dly),  -- sfix40
              ...
              twdl_9_im => twdl_9_im,  -- sfix32_En30
              proc_9_enb => proc_9_enb,
              dout_9_re => dout_9_re,  -- sfix41
              dout_9_im => dout_9_im,  -- sfix41
  ...
  u_NaturalOrder_Stage : RADIX2FFT_bitNatural
    PORT MAP( clk => clk,
              ...
              dout_9_im => dout_9_im,  -- sfix41
              dout_9_vld => dout_9_vld,
              dout_re1 => dout_re1,  -- sfix41
              dout_im1 => dout_im1  -- sfix41
              );
