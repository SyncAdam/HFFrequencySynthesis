...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_3 IS
  ...
  COMPONENT Complex4Multiply
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_re                          :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35
          din_im                          :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35
          din_3_vld_dly                   :   IN    std_logic;
          twdl_3_1_re                     :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          twdl_3_1_im                     :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          dinXTwdl_re                     :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35
          dinXTwdl_im                     :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35
          dinXTwdl_3_1_vld                :   OUT   std_logic
          );
  END COMPONENT;
  ...
  COMPONENT SDFCommutator3
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          din_3_vld_dly                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35
          xf_im                           :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35
          dinXTwdlf_im                    :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35
          btf1_im                         :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35
          btf2_re                         :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35
          btf2_im                         :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35
          btf_vld                         :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35
          wrData_im                       :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35
  ...
  -- Signals
  SIGNAL din_3_1_re_dly_signed            : signed(33 DOWNTO 0);  -- sfix34
  SIGNAL din_re                           : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL din_3_1_im_dly_signed            : signed(33 DOWNTO 0);  -- sfix34
  SIGNAL din_im                           : signed(34 DOWNTO 0);  -- sfix35
  ...
  SIGNAL dinXTwdl_re_signed               : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL dinXTwdl_im_signed               : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL btf2_re                          : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL btf1_im                          : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL btf1_re                          : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL dinXTwdlf_im                     : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL dinXTwdlf_re                     : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL xf_im                            : signed(34 DOWNTO 0);  -- sfix35
  ...
  SIGNAL xf_re                            : signed(34 DOWNTO 0);  -- sfix35
...
BEGIN
  u_MUL4 : Complex4Multiply
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_re => std_logic_vector(din_re),  -- sfix35
              din_im => std_logic_vector(din_im),  -- sfix35
              din_3_vld_dly => din_3_vld_dly,
              twdl_3_1_re => twdl_3_1_re,  -- sfix32_En30
              twdl_3_1_im => twdl_3_1_im,  -- sfix32_En30
              dinXTwdl_re => dinXTwdl_re,  -- sfix35
              dinXTwdl_im => dinXTwdl_im,  -- sfix35
  ...
  u_SDFCOMMUTATOR_3 : SDFCommutator3
    PORT MAP( clk => clk,
              ...
              enb => enb,
              din_3_vld_dly => din_3_vld_dly,
              xf_re => std_logic_vector(xf_re),  -- sfix35
              xf_im => std_logic_vector(xf_im),  -- sfix35
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix35
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix35
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix35
              btf1_im => std_logic_vector(btf1_im),  -- sfix35
              btf2_re => std_logic_vector(btf2_re),  -- sfix35
              btf2_im => std_logic_vector(btf2_im),  -- sfix35
              btf_vld => btf_vld,
              wrData_re => wrData_re,  -- sfix35
              wrData_im => wrData_im,  -- sfix35
              wrAddr => wrAddr,  -- ufix6
              wrEnb => wrEnb,
              dout_3_1_re => dout_3_1_re_tmp,  -- sfix35
              dout_3_1_im => dout_3_1_im_tmp,  -- sfix35
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        Radix22ButterflyG1_btf1_re_reg <= resize(Radix22ButterflyG1_x_re_dly1, 36) + resize(Radix22ButterflyG1_dinXtwdl_re_dly2, 36);
        Radix22ButterflyG1_btf2_re_reg <= resize(Radix22ButterflyG1_x_re_dly1, 36) - resize(Radix22ButterflyG1_dinXtwdl_re_dly2, 36);
        Radix22ButterflyG1_btf1_im_reg <= resize(Radix22ButterflyG1_x_im_dly1, 36) + resize(Radix22ButterflyG1_dinXtwdl_im_dly2, 36);
        Radix22ButterflyG1_btf2_im_reg <= resize(Radix22ButterflyG1_x_im_dly1, 36) - resize(Radix22ButterflyG1_dinXtwdl_im_dly2, 36);
