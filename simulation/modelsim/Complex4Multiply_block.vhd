...
ARCHITECTURE rtl OF Complex4Multiply_block IS
  ...
  -- Signals
  SIGNAL din_re_signed                    : signed(36 DOWNTO 0);  -- sfix37
  SIGNAL din_re_reg                       : signed(36 DOWNTO 0);  -- sfix37
  SIGNAL din_im_signed                    : signed(36 DOWNTO 0);  -- sfix37
  SIGNAL din_im_reg                       : signed(36 DOWNTO 0);  -- sfix37
  ...
  SIGNAL prod1_re                         : signed(68 DOWNTO 0) := to_signed(0, 69);  -- sfix69_En30
  SIGNAL prod1_im                         : signed(68 DOWNTO 0) := to_signed(0, 69);  -- sfix69_En30
  SIGNAL prod2_re                         : signed(68 DOWNTO 0) := to_signed(0, 69);  -- sfix69_En30
  SIGNAL prod2_im                         : signed(68 DOWNTO 0) := to_signed(0, 69);  -- sfix69_En30
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(69 DOWNTO 0);  -- sfix70_En30
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(69 DOWNTO 0);  -- sfix70_En30
  SIGNAL Complex4Add_sub_cast             : signed(69 DOWNTO 0);  -- sfix70_En30
  SIGNAL Complex4Add_sub_cast_1           : signed(69 DOWNTO 0);  -- sfix70_En30
  SIGNAL Complex4Add_add_cast             : signed(69 DOWNTO 0);  -- sfix70_En30
  SIGNAL Complex4Add_add_cast_1           : signed(69 DOWNTO 0);  -- sfix70_En30
  SIGNAL mulResFP_re                      : signed(69 DOWNTO 0);  -- sfix70_En30
  SIGNAL mulResFP_im                      : signed(69 DOWNTO 0);  -- sfix70_En30
  SIGNAL dinXTwdl_5_1_vld_1               : std_logic;
  SIGNAL dinXTwdl_re_tmp                  : signed(36 DOWNTO 0);  -- sfix37
  SIGNAL dinXTwdl_im_tmp                  : signed(36 DOWNTO 0);  -- sfix37
