...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_7 IS
  ...
  COMPONENT Complex4Multiply_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_re                          :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39
          din_im                          :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39
          din_7_vld_dly                   :   IN    std_logic;
          twdl_7_1_re                     :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          twdl_7_1_im                     :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          dinXTwdl_re                     :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39
          dinXTwdl_im                     :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39
          dinXTwdl_7_1_vld                :   OUT   std_logic
          );
  END COMPONENT;
  ...
  COMPONENT SDFCommutator7
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39
          xf_im                           :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39
          dinXTwdlf_im                    :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39
          btf1_im                         :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39
          btf2_re                         :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39
          btf2_im                         :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39
          btf_vld                         :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39
          wrData_im                       :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39
  ...
  -- Signals
  SIGNAL din_7_1_re_dly_signed            : signed(37 DOWNTO 0);  -- sfix38
  SIGNAL din_re                           : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL din_7_1_im_dly_signed            : signed(37 DOWNTO 0);  -- sfix38
  SIGNAL din_im                           : signed(38 DOWNTO 0);  -- sfix39
  ...
  SIGNAL dinXTwdl_re_signed               : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL dinXTwdl_im_signed               : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL btf2_re                          : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL btf1_im                          : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL btf1_re                          : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL dinXTwdlf_im                     : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL dinXTwdlf_re                     : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL xf_im                            : signed(38 DOWNTO 0);  -- sfix39
  ...
  SIGNAL xf_re                            : signed(38 DOWNTO 0);  -- sfix39
...
BEGIN
  u_MUL4 : Complex4Multiply_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_re => std_logic_vector(din_re),  -- sfix39
              din_im => std_logic_vector(din_im),  -- sfix39
              din_7_vld_dly => din_7_vld_dly,
              twdl_7_1_re => twdl_7_1_re,  -- sfix32_En30
              twdl_7_1_im => twdl_7_1_im,  -- sfix32_En30
              dinXTwdl_re => dinXTwdl_re,  -- sfix39
              dinXTwdl_im => dinXTwdl_im,  -- sfix39
  ...
  u_SDFCOMMUTATOR_7 : SDFCommutator7
    PORT MAP( clk => clk,
              ...
              enb => enb,
              din_7_vld_dly => din_7_vld_dly,
              xf_re => std_logic_vector(xf_re),  -- sfix39
              xf_im => std_logic_vector(xf_im),  -- sfix39
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix39
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix39
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix39
              btf1_im => std_logic_vector(btf1_im),  -- sfix39
              btf2_re => std_logic_vector(btf2_re),  -- sfix39
              btf2_im => std_logic_vector(btf2_im),  -- sfix39
              btf_vld => btf_vld,
              wrData_re => wrData_re,  -- sfix39
              wrData_im => wrData_im,  -- sfix39
              wrAddr => wrAddr,  -- ufix2
              wrEnb => wrEnb,
              dout_7_1_re => dout_7_1_re_tmp,  -- sfix39
              dout_7_1_im => dout_7_1_im_tmp,  -- sfix39
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        Radix22ButterflyG1_btf1_re_reg <= resize(Radix22ButterflyG1_x_re_dly1, 40) + resize(Radix22ButterflyG1_dinXtwdl_re_dly2, 40);
        Radix22ButterflyG1_btf2_re_reg <= resize(Radix22ButterflyG1_x_re_dly1, 40) - resize(Radix22ButterflyG1_dinXtwdl_re_dly2, 40);
        Radix22ButterflyG1_btf1_im_reg <= resize(Radix22ButterflyG1_x_im_dly1, 40) + resize(Radix22ButterflyG1_dinXtwdl_im_dly2, 40);
        Radix22ButterflyG1_btf2_im_reg <= resize(Radix22ButterflyG1_x_im_dly1, 40) - resize(Radix22ButterflyG1_dinXtwdl_im_dly2, 40);
