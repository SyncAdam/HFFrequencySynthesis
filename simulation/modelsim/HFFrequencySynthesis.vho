...
SIGNAL \configurator|waiting~feeder_combout\ : std_logic;
...
SIGNAL \WrReEn~DUPLICATE_q\ : std_logic;
...
SIGNAL \ALT_INV_WrReEn~DUPLICATE_q\ : std_logic;
...
\ALT_INV_WrReEn~DUPLICATE_q\ <= NOT \WrReEn~DUPLICATE_q\;
...
-- Location: MLABCELL_X32_Y55_N18
\configurator|Equal1~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|Equal1~0_combout\ = ( \configurator|clockDividerBuffer\(5) & ( !\configurator|clockDividerBuffer\(6) & ( (!\configurator|clockDividerBuffer\(3) & (!\configurator|clockDividerBuffer\(7) & \configurator|clockDividerBuffer\(4))) ) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100110011001100110011001101100011011000110011001100110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \configurator|LessThan0~1_combout\ = ( !\configurator|dataIndex\(7) & ( (!\configurator|dataIndex\(5) & !\configurator|dataIndex\(6)) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \configurator|ALT_INV_dataIndex\(5),
	datac => \configurator|ALT_INV_dataIndex\(6),
	dataf => \configurator|ALT_INV_dataIndex\(7),
...
-- Equation(s):
-- \configurator|counter[6]~0_combout\ = ( \configurator|sendData~DUPLICATE_q\ & ( (!\configurator|LessThan0~1_combout\) # (\configurator|LessThan1~1_combout\) ) )
...
-- Equation(s):
-- \configurator|Add3~9_sumout\ = SUM(( \configurator|counter\(2) ) + ( GND ) + ( \configurator|Add3~6\ ))
-- \configurator|Add3~10\ = CARRY(( \configurator|counter\(2) ) + ( GND ) + ( \configurator|Add3~6\ ))
...
-- Equation(s):
-- \configurator|Add3~13_sumout\ = SUM(( \configurator|counter\(3) ) + ( GND ) + ( \configurator|Add3~10\ ))
-- \configurator|Add3~14\ = CARRY(( \configurator|counter\(3) ) + ( GND ) + ( \configurator|Add3~10\ ))
...
-- Location: MLABCELL_X32_Y53_N51
\configurator|LessThan2~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|LessThan2~0_combout\ = ( \configurator|counter\(3) ) # ( !\configurator|counter\(3) & ( ((\configurator|counter\(4)) # (\configurator|counter\(5))) # (\configurator|counter\(6)) ) )
...
-- Equation(s):
-- \configurator|configOK~0_combout\ = ( \configurator|configOK~reg0_q\ ) # ( !\configurator|configOK~reg0_q\ & ( (\configurator|LessThan2~0_combout\ & (\configurator|sendData~q\ & ((!\configurator|LessThan0~1_combout\) # 
-- (\configurator|LessThan1~1_combout\)))) ) )
...
-- Location: MLABCELL_X32_Y54_N18
\configurator|waitingBuffer[1]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|waitingBuffer[1]~1_combout\ = ( \configurator|waiting~q\ & ( \configurator|waitingBuffer\(0) & ( !\configurator|waitingBuffer\(1) ) ) ) # ( !\configurator|waiting~q\ & ( \configurator|waitingBuffer\(0) & ( \configurator|waitingBuffer\(1) ) ) 
-- ) # ( \configurator|waiting~q\ & ( !\configurator|waitingBuffer\(0) & ( \configurator|waitingBuffer\(1) ) ) ) # ( !\configurator|waiting~q\ & ( !\configurator|waitingBuffer\(0) & ( \configurator|waitingBuffer\(1) ) ) )
...
-- Location: MLABCELL_X32_Y54_N0
\configurator|waitingBuffer[2]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|waitingBuffer[2]~0_combout\ = ( \configurator|waitingBuffer\(2) & ( \configurator|waitingBuffer\(1) & ( (!\configurator|waitingBuffer\(0)) # (!\configurator|waiting~q\) ) ) ) # ( !\configurator|waitingBuffer\(2) & ( 
-- \configurator|waitingBuffer\(1) & ( (\configurator|waitingBuffer\(0) & \configurator|waiting~q\) ) ) ) # ( \configurator|waitingBuffer\(2) & ( !\configurator|waitingBuffer\(1) ) )
...
-- Equation(s):
-- \configurator|Selector1~0_combout\ = ( \configurator|needWait~q\ & ( \configurator|state.SEND~q\ & ( (!\configurator|configOK~reg0_q\ & ((!\writeconfig~input_o\) # ((!\configurator|waitingDone~q\ & \configurator|state.INTER~q\)))) # 
-- (\configurator|configOK~reg0_q\ & (((!\configurator|waitingDone~q\ & \configurator|state.INTER~q\)))) ) ) ) # ( !\configurator|needWait~q\ & ( \configurator|state.SEND~q\ & ( (!\configurator|waitingDone~q\ & \configurator|state.INTER~q\) ) ) ) # ( 
-- \configurator|needWait~q\ & ( !\configurator|state.SEND~q\ & ( (!\configurator|waitingDone~q\ & \configurator|state.INTER~q\) ) ) ) # ( !\configurator|needWait~q\ & ( !\configurator|state.SEND~q\ & ( (!\configurator|waitingDone~q\ & 
-- \configurator|state.INTER~q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011110000000000001111000000000000111100001000100011111000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \configurator|ALT_INV_configOK~reg0_q\,
	datab => \ALT_INV_writeconfig~input_o\,
	datac => \configurator|ALT_INV_waitingDone~q\,
...
-- Location: MLABCELL_X32_Y54_N45
\configurator|waiting~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|waiting~feeder_combout\ = ( \configurator|state.INTER~DUPLICATE_q\ )
...
PORT MAP (
	...
	combout => \configurator|waiting~feeder_combout\);

-- Location: FF_X32_Y54_N47
...
PORT MAP (
	clk => \inputClock~inputCLKENA0_outclk\,
	d => \configurator|waiting~feeder_combout\,
	clrn => \resetn~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \configurator|waiting~q\);

-- Location: MLABCELL_X32_Y54_N15
\configurator|discardBuffer~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|discardBuffer~0_combout\ = ( !\configurator|waiting~q\ & ( \configurator|discarding~q\ & ( !\configurator|discardBuffer~reg0_q\ ) ) )
...
-- pragma translate_on
PORT MAP (
	dataf => \configurator|ALT_INV_discardBuffer~0_combout\,
	combout => \configurator|discardBuffer~reg0feeder_combout\);

-- Location: FF_X32_Y54_N41
...
-- Location: MLABCELL_X32_Y54_N6
\configurator|discarded~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|discarded~0_combout\ = ( !\configurator|waiting~q\ & ( \configurator|discarded~q\ ) ) # ( !\configurator|waiting~q\ & ( !\configurator|discarded~q\ & ( \configurator|discardBuffer~reg0_q\ ) ) )
...
-- Equation(s):
-- \configurator|nextState~9_combout\ = ( \configurator|state.DISCARD~DUPLICATE_q\ ) # ( !\configurator|state.DISCARD~DUPLICATE_q\ & ( (!\writeconfig~input_o\) # (\configurator|state.INTER~q\) ) )
...
PORT MAP (
	...
	dataf => \configurator|ALT_INV_state.DISCARD~DUPLICATE_q\,
...
-- Equation(s):
-- \configurator|Selector2~0_combout\ = ( \configurator|state.DISCARD~q\ & ( \configurator|waitingDone~q\ & ( (!\configurator|discarded~q\) # (((!\writeconfig~input_o\ & !\configurator|state.IDLE~q\)) # (\configurator|state.INTER~q\)) ) ) ) # ( 
-- !\configurator|state.DISCARD~q\ & ( \configurator|waitingDone~q\ & ( ((!\writeconfig~input_o\ & !\configurator|state.IDLE~q\)) # (\configurator|state.INTER~q\) ) ) ) # ( \configurator|state.DISCARD~q\ & ( !\configurator|waitingDone~q\ & ( 
...
-- Equation(s):
-- \configurator|needWait~0_combout\ = ( \configurator|sendData~q\ & ( !\configurator|discarding~q\ & ( (!\configurator|LessThan0~1_combout\) # (\configurator|LessThan1~1_combout\) ) ) ) # ( !\configurator|sendData~q\ & ( !\configurator|discarding~q\ & ( 
-- \configurator|needWait~q\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101010101111111110011001100000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \configurator|ALT_INV_sendData~q\,
	dataf => \configurator|ALT_INV_discarding~q\,
	combout => \configurator|needWait~0_combout\);

-- Location: FF_X31_Y53_N35
...
-- Equation(s):
-- \configurator|Selector0~0_combout\ = ( \configurator|discarded~q\ & ( \configurator|state.SEND~q\ & ( ((!\configurator|needWait~q\ & (!\configurator|configOK~reg0_q\ & !\writeconfig~input_o\))) # (\configurator|state.DISCARD~DUPLICATE_q\) ) ) ) # ( 
-- !\configurator|discarded~q\ & ( \configurator|state.SEND~q\ & ( (!\configurator|needWait~q\ & (!\configurator|configOK~reg0_q\ & !\writeconfig~input_o\)) ) ) ) # ( \configurator|discarded~q\ & ( !\configurator|state.SEND~q\ & ( 
-- \configurator|state.DISCARD~DUPLICATE_q\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000001111111110000000100000001000000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \configurator|ALT_INV_needWait~q\,
	...
	datae => \configurator|ALT_INV_discarded~q\,
	dataf => \configurator|ALT_INV_state.SEND~q\,
...
-- Equation(s):
-- \configurator|dataIndex[2]~1_combout\ = ( \configurator|discarding~q\ ) # ( !\configurator|discarding~q\ & ( \configurator|sendData~q\ ) )
...
-- Equation(s):
-- \configurator|LessThan1~1_combout\ = ( \configurator|dataIndex\(3) & ( \configurator|dataIndex\(2) & ( \configurator|dataIndex\(4) ) ) ) # ( !\configurator|dataIndex\(3) & ( \configurator|dataIndex\(2) & ( (\configurator|dataIndex\(4) & 
-- (\configurator|dataIndex\(0) & \configurator|dataIndex\(1))) ) ) ) # ( \configurator|dataIndex\(3) & ( !\configurator|dataIndex\(2) & ( \configurator|dataIndex\(4) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000010101010101010100000001000000010101010101010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \configurator|dataIndex[2]~0_combout\ = ((!\configurator|LessThan0~1_combout\) # (\configurator|discarding~q\)) # (\configurator|LessThan1~1_combout\)
...
-- Location: LABCELL_X31_Y53_N57
\configurator|LessThan0~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|LessThan0~0_combout\ = ( !\configurator|dataIndex\(7) & ( (!\configurator|dataIndex\(5) & (!\configurator|dataIndex\(6) & !\configurator|dataIndex\(4))) ) )
...
-- Location: MLABCELL_X32_Y53_N12
\configurator|SDIO~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|SDIO~2_combout\ = ( \configurator|counter\(3) & ( (!\configurator|dataIndex\(1) & ((!\configurator|dataIndex\(0) & ((\configurator|counter\(6)))) # (\configurator|dataIndex\(0) & (\configurator|counter\(5))))) # (\configurator|dataIndex\(1) 
-- & (\configurator|dataIndex\(0))) ) ) # ( !\configurator|counter\(3) & ( (!\configurator|dataIndex\(1) & ((!\configurator|dataIndex\(0) & ((\configurator|counter\(6)))) # (\configurator|dataIndex\(0) & (\configurator|counter\(5))))) ) )
...
-- Location: MLABCELL_X32_Y53_N21
\configurator|SDIO~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|SDIO~3_combout\ = ( \configurator|LessThan0~0_combout\ & ( \configurator|SDIO~2_combout\ & ( (!\configurator|dataIndex\(2) & (\configurator|sendData~q\ & (!\configurator|dataIndex\(3) & !\configurator|discarding~q\))) ) ) )
...
PORT MAP (
	...
	dataf => \configurator|ALT_INV_SDIO~2_combout\,
	combout => \configurator|SDIO~3_combout\);

-- Location: LABCELL_X31_Y53_N45
\configurator|LessThan1~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|LessThan1~0_combout\ = ( \configurator|dataIndex\(0) & ( (!\configurator|dataIndex\(3) & ((!\configurator|dataIndex\(2)) # (!\configurator|dataIndex\(1)))) ) ) # ( !\configurator|dataIndex\(0) & ( !\configurator|dataIndex\(3) ) )
...
-- Location: MLABCELL_X32_Y53_N48
\configurator|SDIO~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|SDIO~0_combout\ = ( \configurator|LessThan1~0_combout\ & ( (\configurator|sendData~q\ & (!\configurator|discarding~q\ & !\configurator|LessThan0~0_combout\)) ) ) # ( !\configurator|LessThan1~0_combout\ & ( (\configurator|sendData~q\ & 
-- !\configurator|discarding~q\) ) )
...
-- Equation(s):
-- \configurator|SDIO~7_combout\ = ( \configurator|sendData~DUPLICATE_q\ & ( (!\configurator|discarding~q\ & ((!\configurator|dataIndex\(1) & ((\configurator|dataIndex\(2)))) # (\configurator|dataIndex\(1) & (!\configurator|dataIndex\(0))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000001100100010000000110010001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- !\configurator|counter\(4) & ( \configurator|SDIO~7_combout\ & ( (\configurator|Mux0~0_combout\ & (\configurator|dataIndex\(2) & (\configurator|LessThan0~0_combout\ & \configurator|LessThan1~0_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000000000000000010000000000001101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \configurator|ALT_INV_Mux0~0_combout\,
	datab => \configurator|ALT_INV_dataIndex\(2),
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \WrReEn~DUPLICATE_q\);

-- Location: LABCELL_X33_Y53_N57
\configurator|Mux1~11\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|Mux1~11_combout\ = ( !\configurator|counter\(2) & ( !\configurator|counter\(3) & ( (!\configurator|counter\(1) & !\configurator|counter\(0)) ) ) )
...
-- Location: MLABCELL_X32_Y53_N0
\configurator|Mux1~14\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|Mux1~14_combout\ = ( \configurator|counter\(0) & ( (!\configurator|dataIndex\(2) & (!\configurator|dataIndex\(1) $ (((\configurator|dataIndex\(3)))))) # (\configurator|dataIndex\(2) & (\configurator|dataIndex\(3) & 
-- (!\configurator|dataIndex\(1) $ (\configurator|counter\(2))))) ) ) # ( !\configurator|counter\(0) & ( (!\configurator|dataIndex\(1) & (\configurator|dataIndex\(2) & (!\configurator|counter\(2) & \configurator|dataIndex\(3)))) # 
-- (\configurator|dataIndex\(1) & (((\configurator|counter\(2))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000001101000011000000110100001110001000011000111000100001100011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \configurator|ALT_INV_dataIndex\(2),
...
-- Location: MLABCELL_X32_Y53_N39
\configurator|Mux1~10\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|Mux1~10_combout\ = ( \configurator|Mux1~14_combout\ & ( \configurator|counter\(2) & ( (\configurator|counter\(3) & (!\configurator|dataIndex\(0) & \configurator|counter\(1))) ) ) ) # ( \configurator|Mux1~14_combout\ & ( 
-- !\configurator|counter\(2) & ( (\configurator|counter\(3) & ((!\configurator|dataIndex\(0) & (!\configurator|dataIndex\(1) & !\configurator|counter\(1))) # (\configurator|dataIndex\(0) & (\configurator|dataIndex\(1) & \configurator|counter\(1))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000010000000000000100000000000000000000000001000100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \configurator|ALT_INV_Mux1~14_combout\,
	dataf => \configurator|ALT_INV_counter\(2),
	combout => \configurator|Mux1~10_combout\);

-- Location: MLABCELL_X32_Y53_N57
\configurator|Mux1~8\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|Mux1~8_combout\ = ( \configurator|dataIndex\(1) & ( \configurator|dataIndex\(0) & ( (!\configurator|counter\(2) & \configurator|counter\(0)) ) ) ) # ( !\configurator|dataIndex\(1) & ( \configurator|dataIndex\(0) & ( 
-- (!\configurator|counter\(2) & ((\configurator|dataIndex\(2)) # (\configurator|counter\(0)))) ) ) ) # ( \configurator|dataIndex\(1) & ( !\configurator|dataIndex\(0) & ( (!\configurator|counter\(2) & (!\configurator|counter\(0) & 
-- !\configurator|dataIndex\(2))) ) ) ) # ( !\configurator|dataIndex\(1) & ( !\configurator|dataIndex\(0) & ( (!\configurator|counter\(2) & (!\configurator|counter\(0) & \configurator|dataIndex\(2))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011000000110000000000000000001100110011000000110000001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Location: MLABCELL_X32_Y53_N24
\configurator|Mux1~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|Mux1~6_combout\ = ( \configurator|dataIndex\(1) & ( \configurator|dataIndex\(3) & ( (!\configurator|counter\(0) & (\configurator|dataIndex\(2) & (!\configurator|dataIndex\(0) $ (\configurator|counter\(2))))) # (\configurator|counter\(0) & 
-- (((!\configurator|dataIndex\(2) & !\configurator|counter\(2))))) ) ) ) # ( !\configurator|dataIndex\(1) & ( \configurator|dataIndex\(3) & ( (!\configurator|dataIndex\(0) & (!\configurator|counter\(0))) # (\configurator|dataIndex\(0) & 
-- (\configurator|dataIndex\(2) & (!\configurator|counter\(0) $ (!\configurator|counter\(2))))) ) ) ) # ( \configurator|dataIndex\(1) & ( !\configurator|dataIndex\(3) & ( (!\configurator|counter\(0) & (\configurator|dataIndex\(2) & 
-- (!\configurator|dataIndex\(0) $ (\configurator|counter\(2))))) # (\configurator|counter\(0) & (((!\configurator|dataIndex\(2) & !\configurator|counter\(2))))) ) ) ) # ( !\configurator|dataIndex\(1) & ( !\configurator|dataIndex\(3) & ( 
-- (!\configurator|dataIndex\(0) & ((!\configurator|counter\(0)) # ((\configurator|dataIndex\(2) & \configurator|counter\(2))))) # (\configurator|dataIndex\(0) & (\configurator|dataIndex\(2) & (!\configurator|counter\(0) $ (!\configurator|counter\(2))))) ) ) 
-- )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1000100110001110001110000000010010001001100011000011100000000100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \configurator|ALT_INV_dataIndex\(0),
...
-- Equation(s):
-- \configurator|Mux1~5_combout\ = ( \configurator|counter\(0) & ( \configurator|counter\(2) & ( (!\configurator|dataIndex\(2)) # ((!\configurator|dataIndex\(1) & \configurator|dataIndex\(0))) ) ) ) # ( !\configurator|counter\(0) & ( 
-- !\configurator|counter\(2) & ( (\configurator|dataIndex\(3) & (!\configurator|dataIndex\(1) & (!\configurator|dataIndex\(2) $ (!\configurator|dataIndex\(0))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010001000000000000000000000000000000000000001111000011111100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Location: MLABCELL_X32_Y53_N15
\configurator|Mux1~7\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|Mux1~7_combout\ = ( \configurator|dataIndex\(2) & ( (!\configurator|dataIndex\(0) & (!\configurator|counter\(2) $ (((\configurator|counter\(0)) # (\configurator|dataIndex\(1)))))) # (\configurator|dataIndex\(0) & (\configurator|dataIndex\(1) 
-- & (!\configurator|counter\(2) & !\configurator|counter\(0)))) ) ) # ( !\configurator|dataIndex\(2) & ( (!\configurator|dataIndex\(1) & (!\configurator|counter\(0) & ((!\configurator|dataIndex\(0)) # (!\configurator|counter\(2))))) # 
-- (\configurator|dataIndex\(1) & (\configurator|counter\(2) & (!\configurator|dataIndex\(0) $ (!\configurator|counter\(0))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010100100000100101010010000010010010100000011001001010000001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \configurator|ALT_INV_dataIndex\(1),
...
-- Equation(s):
-- \configurator|Mux1~9_combout\ = ( \configurator|Mux1~5_combout\ & ( \configurator|Mux1~7_combout\ & ( (!\configurator|counter\(1) & (((!\configurator|counter\(3)) # (\configurator|Mux1~6_combout\)))) # (\configurator|counter\(1) & 
-- (\configurator|Mux1~8_combout\ & ((\configurator|counter\(3))))) ) ) ) # ( !\configurator|Mux1~5_combout\ & ( \configurator|Mux1~7_combout\ & ( (\configurator|counter\(3) & ((!\configurator|counter\(1) & ((\configurator|Mux1~6_combout\))) # 
-- (\configurator|counter\(1) & (\configurator|Mux1~8_combout\)))) ) ) ) # ( \configurator|Mux1~5_combout\ & ( !\configurator|Mux1~7_combout\ & ( (!\configurator|counter\(3)) # ((!\configurator|counter\(1) & ((\configurator|Mux1~6_combout\))) # 
-- (\configurator|counter\(1) & (\configurator|Mux1~8_combout\))) ) ) ) # ( !\configurator|Mux1~5_combout\ & ( !\configurator|Mux1~7_combout\ & ( (!\configurator|counter\(1) & (((\configurator|Mux1~6_combout\ & \configurator|counter\(3))))) # 
-- (\configurator|counter\(1) & (((!\configurator|counter\(3))) # (\configurator|Mux1~8_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010100011011111111110001101100000000000110111010101000011011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \configurator|ALT_INV_counter\(1),
	datab => \configurator|ALT_INV_Mux1~8_combout\,
	datac => \configurator|ALT_INV_Mux1~6_combout\,
	datad => \configurator|ALT_INV_counter\(3),
	datae => \configurator|ALT_INV_Mux1~5_combout\,
	dataf => \configurator|ALT_INV_Mux1~7_combout\,
	combout => \configurator|Mux1~9_combout\);

-- Location: LABCELL_X31_Y53_N30
\configurator|Mux1~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|Mux1~0_combout\ = ( \configurator|counter\(0) & ( \configurator|counter\(1) & ( (\configurator|dataIndex\(0) & ((!\configurator|dataIndex\(1) & (\configurator|dataIndex\(3) & !\configurator|dataIndex\(2))) # (\configurator|dataIndex\(1) & 
-- (!\configurator|dataIndex\(3) & \configurator|dataIndex\(2))))) ) ) ) # ( !\configurator|counter\(0) & ( \configurator|counter\(1) & ( (!\configurator|dataIndex\(0) & (((!\configurator|dataIndex\(2))))) # (\configurator|dataIndex\(0) & 
-- (!\configurator|dataIndex\(1) & (!\configurator|dataIndex\(3) $ (!\configurator|dataIndex\(2))))) ) ) ) # ( \configurator|counter\(0) & ( !\configurator|counter\(1) & ( (!\configurator|dataIndex\(0) & (!\configurator|dataIndex\(1) & 
-- ((\configurator|dataIndex\(2))))) # (\configurator|dataIndex\(0) & (!\configurator|dataIndex\(3) & (!\configurator|dataIndex\(1) $ (!\configurator|dataIndex\(2))))) ) ) ) # ( !\configurator|counter\(0) & ( !\configurator|counter\(1) & ( 
-- (!\configurator|dataIndex\(1) & ((!\configurator|dataIndex\(3) $ (!\configurator|dataIndex\(2))))) # (\configurator|dataIndex\(1) & ((!\configurator|dataIndex\(0)) # ((!\configurator|dataIndex\(3)) # (\configurator|dataIndex\(2))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011111011110011000100001100100010101110010000000000010000010000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \configurator|ALT_INV_dataIndex\(0),
...
-- Equation(s):
-- \configurator|Mux1~2_combout\ = ( \configurator|counter\(0) & ( !\configurator|counter\(1) & ( (!\configurator|dataIndex\(3) & (\configurator|dataIndex\(2) & (\configurator|dataIndex\(0) & \configurator|dataIndex\(1)))) ) ) )
...
-- Location: MLABCELL_X32_Y53_N3
\configurator|Mux1~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|Mux1~3_combout\ = (\configurator|dataIndex\(2) & (!\configurator|dataIndex\(1) & (!\configurator|dataIndex\(0) & \configurator|dataIndex\(3))))
...
-- Equation(s):
-- \configurator|Mux1~1_combout\ = ( \configurator|counter\(0) & ( \configurator|counter\(1) & ( (!\configurator|dataIndex\(3)) # ((!\configurator|dataIndex\(0) & ((!\configurator|dataIndex\(2)))) # (\configurator|dataIndex\(0) & 
-- (\configurator|dataIndex\(1)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000000000000000001111111110110001",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \configurator|ALT_INV_dataIndex\(0),
...
-- Location: MLABCELL_X32_Y53_N45
\configurator|Mux1~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \configurator|Mux1~4_combout\ = ( \configurator|Mux1~3_combout\ & ( \configurator|Mux1~1_combout\ & ( ((!\configurator|counter\(3) & (\configurator|Mux1~0_combout\)) # (\configurator|counter\(3) & ((\configurator|Mux1~2_combout\)))) # 
-- (\configurator|counter\(2)) ) ) ) # ( !\configurator|Mux1~3_combout\ & ( \configurator|Mux1~1_combout\ & ( (!\configurator|counter\(3) & (((\configurator|counter\(2))) # (\configurator|Mux1~0_combout\))) # (\configurator|counter\(3) & 
-- (((!\configurator|counter\(2) & \configurator|Mux1~2_combout\)))) ) ) ) # ( \configurator|Mux1~3_combout\ & ( !\configurator|Mux1~1_combout\ & ( (!\configurator|counter\(3) & (\configurator|Mux1~0_combout\ & (!\configurator|counter\(2)))) # 
-- (\configurator|counter\(3) & (((\configurator|Mux1~2_combout\) # (\configurator|counter\(2))))) ) ) ) # ( !\configurator|Mux1~3_combout\ & ( !\configurator|Mux1~1_combout\ & ( (!\configurator|counter\(2) & ((!\configurator|counter\(3) & 
...
PORT MAP (
	...
	datae => \configurator|ALT_INV_Mux1~3_combout\,
...
-- Equation(s):
-- \configurator|Mux1~12_combout\ = ( \configurator|Mux1~9_combout\ & ( \configurator|Mux1~4_combout\ & ( (!\configurator|counter\(4)) # ((!\configurator|counter\(5) & ((\configurator|Mux1~10_combout\))) # (\configurator|counter\(5) & 
-- (\configurator|Mux1~11_combout\))) ) ) ) # ( !\configurator|Mux1~9_combout\ & ( \configurator|Mux1~4_combout\ & ( (!\configurator|counter\(4) & (!\configurator|counter\(5))) # (\configurator|counter\(4) & ((!\configurator|counter\(5) & 
-- ((\configurator|Mux1~10_combout\))) # (\configurator|counter\(5) & (\configurator|Mux1~11_combout\)))) ) ) ) # ( \configurator|Mux1~9_combout\ & ( !\configurator|Mux1~4_combout\ & ( (!\configurator|counter\(4) & (\configurator|counter\(5))) # 
-- (\configurator|counter\(4) & ((!\configurator|counter\(5) & ((\configurator|Mux1~10_combout\))) # (\configurator|counter\(5) & (\configurator|Mux1~11_combout\)))) ) ) ) # ( !\configurator|Mux1~9_combout\ & ( !\configurator|Mux1~4_combout\ & ( 
...
PORT MAP (
	...
	datae => \configurator|ALT_INV_Mux1~9_combout\,
...
-- Equation(s):
-- \configurator|SDIO~4_combout\ = ( \WrReEn~DUPLICATE_q\ & ( \configurator|Mux1~12_combout\ & ( (((\configurator|SDIO~1_combout\) # (\configurator|discarding~q\)) # (\configurator|SDIO~0_combout\)) # (\configurator|SDIO~3_combout\) ) ) ) # ( 
-- !\WrReEn~DUPLICATE_q\ & ( \configurator|Mux1~12_combout\ & ( ((\configurator|SDIO~1_combout\) # (\configurator|SDIO~0_combout\)) # (\configurator|SDIO~3_combout\) ) ) ) # ( \WrReEn~DUPLICATE_q\ & ( !\configurator|Mux1~12_combout\ & ( 
-- ((\configurator|SDIO~1_combout\) # (\configurator|discarding~q\)) # (\configurator|SDIO~3_combout\) ) ) ) # ( !\WrReEn~DUPLICATE_q\ & ( !\configurator|Mux1~12_combout\ & ( (\configurator|SDIO~1_combout\) # (\configurator|SDIO~3_combout\) ) ) )
...
PORT MAP (
	...
	datab => \configurator|ALT_INV_SDIO~0_combout\,
	datac => \configurator|ALT_INV_discarding~q\,
	datad => \configurator|ALT_INV_SDIO~1_combout\,
	datae => \ALT_INV_WrReEn~DUPLICATE_q\,
...
-- Equation(s):
-- \configurator|SDIO~5_combout\ = ( \configurator|LessThan0~1_combout\ & ( \configurator|sendData~DUPLICATE_q\ & ( ((!\configurator|dataIndex\(4)) # (\configurator|discarding~q\)) # (\configurator|LessThan1~0_combout\) ) ) ) # ( 
-- !\configurator|LessThan0~1_combout\ & ( \configurator|sendData~DUPLICATE_q\ & ( \configurator|discarding~q\ ) ) ) # ( \configurator|LessThan0~1_combout\ & ( !\configurator|sendData~DUPLICATE_q\ ) ) # ( !\configurator|LessThan0~1_combout\ & ( 
-- !\configurator|sendData~DUPLICATE_q\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111111111111111111100000000111111111111001111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \configurator|SDIO~6_combout\ = ( \configurator|LessThan0~0_combout\ & ( \WrReEn~q\ & ( (\configurator|sendData~q\ & (!\configurator|LessThan1~0_combout\ & !\configurator|discarding~q\)) ) ) ) # ( !\configurator|LessThan0~0_combout\ & ( \WrReEn~q\ & ( 
-- (\configurator|sendData~q\ & !\configurator|discarding~q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000001010101000000000101000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \configurator|ALT_INV_sendData~q\,
...
-- Equation(s):
-- \configurator|Mux1~13_combout\ = ( \configurator|dataIndex\(0) & ( (\configurator|dataIndex\(1) & (!\configurator|dataIndex\(3) & \configurator|dataIndex\(2))) ) )
...
-- Equation(s):
-- \configurator|outputClock~0_combout\ = ( \configurator|internalClock~q\ & ( \configurator|dataIndex\(4) & ( \configurator|state.SEND~q\ ) ) ) # ( !\configurator|internalClock~q\ & ( \configurator|dataIndex\(4) & ( (\configurator|state.SEND~q\ & 
-- ((!\configurator|LessThan0~1_combout\) # (!\configurator|Mux1~13_combout\))) ) ) ) # ( \configurator|internalClock~q\ & ( !\configurator|dataIndex\(4) & ( \configurator|state.SEND~q\ ) ) ) # ( !\configurator|internalClock~q\ & ( 
-- !\configurator|dataIndex\(4) & ( \configurator|state.SEND~q\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111100001111000011110000111100001110000011100000111100001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \configurator|ALT_INV_LessThan0~1_combout\,
	datab => \configurator|ALT_INV_Mux1~13_combout\,
...
PORT MAP (
	clk => \inputClock~inputCLKENA0_outclk\,
	d => \configurator|outputClock~0_combout\,
	clrn => \resetn~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \configurator|SCLK~0_combout\ = ( \configurator|outputClock~q\ & ( (\configurator|internalClock~q\ & (!\configurator|needWait~q\ & \resetn~input_o\)) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \configurator|ALT_INV_state.DISCARD~DUPLICATE_q\,
	dataf => \configurator|ALT_INV_state.SEND~q\,
...
-- pragma translate_on
PORT MAP (
	dataf => \ALT_INV_innerDataClock~0_combout\,
	combout => \innerDataClock~feeder_combout\);

-- Location: LABCELL_X45_Y59_N24
...
-- Location: LABCELL_X45_Y59_N6
\Equal0~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \Equal0~0_combout\ = ( !clockDivideBuffer(1) & ( (!clockDivideBuffer(2) & (!clockDivideBuffer(0) & !clockDivideBuffer(3))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => ALT_INV_clockDivideBuffer(2),
	datac => ALT_INV_clockDivideBuffer(0),
	datad => ALT_INV_clockDivideBuffer(3),
	dataf => ALT_INV_clockDivideBuffer(1),
	combout => \Equal0~0_combout\);

-- Location: LABCELL_X45_Y59_N54
\Equal0~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \Equal0~1_combout\ = ( \Equal0~0_combout\ & ( (!clockDivideBuffer(6) & (!clockDivideBuffer(4) & (!clockDivideBuffer(5) & !clockDivideBuffer(7)))) ) )
...
PORT MAP (
	...
	datac => ALT_INV_clockDivideBuffer(5),
	datad => ALT_INV_clockDivideBuffer(7),
...
-- pragma translate_on
PORT MAP (
	datab => \synthesizer|ALT_INV_counter\(8),
...
-- pragma translate_on
PORT MAP (
	datac => \synthesizer|ALT_INV_counter\(16),
...
-- Location: LABCELL_X45_Y59_N18
\synthesizer|LessThan0~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|LessThan0~0_combout\ = ( !\synthesizer|Add0~57_sumout\ & ( !\synthesizer|Add0~49_sumout\ & ( (!\synthesizer|Add0~45_sumout\ & (!\synthesizer|Add0~53_sumout\ & !\synthesizer|Add0~41_sumout\)) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \synthesizer|ALT_INV_Add0~45_sumout\,
	datac => \synthesizer|ALT_INV_Add0~53_sumout\,
	datad => \synthesizer|ALT_INV_Add0~41_sumout\,
	datae => \synthesizer|ALT_INV_Add0~57_sumout\,
	dataf => \synthesizer|ALT_INV_Add0~49_sumout\,
	combout => \synthesizer|LessThan0~0_combout\);

-- Location: LABCELL_X46_Y58_N45
\synthesizer|LessThan0~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|LessThan0~1_combout\ = ( \synthesizer|LessThan0~0_combout\ & ( !\synthesizer|Add0~29_sumout\ & ( (!\synthesizer|Add0~33_sumout\ & (!\synthesizer|Add0~37_sumout\ & (!\synthesizer|Add0~21_sumout\ & !\synthesizer|Add0~25_sumout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \synthesizer|ALT_INV_Add0~33_sumout\,
	datab => \synthesizer|ALT_INV_Add0~37_sumout\,
	datac => \synthesizer|ALT_INV_Add0~21_sumout\,
	datad => \synthesizer|ALT_INV_Add0~25_sumout\,
	datae => \synthesizer|ALT_INV_LessThan0~0_combout\,
	dataf => \synthesizer|ALT_INV_Add0~29_sumout\,
	combout => \synthesizer|LessThan0~1_combout\);

-- Location: LABCELL_X46_Y58_N57
\synthesizer|LessThan0~5\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|LessThan0~5_combout\ = ( !\synthesizer|Add0~89_sumout\ & ( !\synthesizer|Add0~61_sumout\ & ( (!\synthesizer|Add0~93_sumout\ & !\synthesizer|Add0~97_sumout\) ) ) )
...
-- pragma translate_on
PORT MAP (
	datac => \synthesizer|ALT_INV_Add0~93_sumout\,
	datad => \synthesizer|ALT_INV_Add0~97_sumout\,
	datae => \synthesizer|ALT_INV_Add0~89_sumout\,
	dataf => \synthesizer|ALT_INV_Add0~61_sumout\,
	combout => \synthesizer|LessThan0~5_combout\);

-- Location: LABCELL_X45_Y59_N12
\synthesizer|LessThan0~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|LessThan0~4_combout\ = ( !\synthesizer|Add0~85_sumout\ & ( !\synthesizer|Add0~101_sumout\ & ( (!\synthesizer|Add0~113_sumout\ & (!\synthesizer|Add0~109_sumout\ & (!\synthesizer|Add0~105_sumout\ & !\synthesizer|Add0~81_sumout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \synthesizer|ALT_INV_Add0~113_sumout\,
	datab => \synthesizer|ALT_INV_Add0~109_sumout\,
	datac => \synthesizer|ALT_INV_Add0~105_sumout\,
	datad => \synthesizer|ALT_INV_Add0~81_sumout\,
	datae => \synthesizer|ALT_INV_Add0~85_sumout\,
	dataf => \synthesizer|ALT_INV_Add0~101_sumout\,
	combout => \synthesizer|LessThan0~4_combout\);

-- Location: LABCELL_X46_Y58_N51
\synthesizer|LessThan0~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|LessThan0~2_combout\ = ( !\synthesizer|Add0~77_sumout\ & ( !\synthesizer|Add0~73_sumout\ & ( (!\synthesizer|Add0~65_sumout\ & (!\synthesizer|Add0~69_sumout\ & (\synthesizer|LessThan0~5_combout\ & \synthesizer|LessThan0~4_combout\))) ) ) )
...
PORT MAP (
	...
	datab => \synthesizer|ALT_INV_Add0~69_sumout\,
	datac => \synthesizer|ALT_INV_LessThan0~5_combout\,
	datad => \synthesizer|ALT_INV_LessThan0~4_combout\,
	datae => \synthesizer|ALT_INV_Add0~77_sumout\,
	dataf => \synthesizer|ALT_INV_Add0~73_sumout\,
	combout => \synthesizer|LessThan0~2_combout\);

-- Location: LABCELL_X46_Y58_N36
...
-- Equation(s):
-- \synthesizer|Mux11~0_combout\ = (!\synthesizer|counter\(1) & (((!\synthesizer|counter\(2))) # (\synthesizer|counter\(0)))) # (\synthesizer|counter\(1) & (((\synthesizer|counter\(0) & !\synthesizer|counter[3]~DUPLICATE_q\)) # (\synthesizer|counter\(2))))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1011011110100111101101111010011110110111101001111011011110100111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \synthesizer|ALT_INV_counter\(1),
	datab => \synthesizer|ALT_INV_counter\(0),
	datac => \synthesizer|ALT_INV_counter\(2),
	datad => \synthesizer|ALT_INV_counter[3]~DUPLICATE_q\,
	combout => \synthesizer|Mux11~0_combout\);

-- Location: FF_X45_Y58_N2
...
PORT MAP (
	clk => \innerDataClock~q\,
	d => \synthesizer|Mux11~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \synthesizer|output_p\(0));

-- Location: LABCELL_X45_Y58_N45
\synthesizer|Mux10~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|Mux10~0_combout\ = ( \synthesizer|counter\(0) & ( (\synthesizer|counter\(1) & ((!\synthesizer|counter[3]~DUPLICATE_q\) # (\synthesizer|counter\(2)))) ) ) # ( !\synthesizer|counter\(0) & ( (!\synthesizer|counter\(1) $ 
-- (\synthesizer|counter\(2))) # (\synthesizer|counter[3]~DUPLICATE_q\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1101110101110111110111010111011100100010001100110010001000110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	dataf => \synthesizer|ALT_INV_counter\(0),
	combout => \synthesizer|Mux10~0_combout\);

-- Location: FF_X45_Y58_N46
...
-- Location: LABCELL_X45_Y58_N12
\synthesizer|Mux9~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|Mux9~0_combout\ = ( \synthesizer|counter\(1) & ( !\synthesizer|counter\(0) $ (((!\synthesizer|counter[3]~DUPLICATE_q\) # (\synthesizer|counter\(2)))) ) ) # ( !\synthesizer|counter\(1) & ( (\synthesizer|counter[3]~DUPLICATE_q\ & 
-- ((\synthesizer|counter\(2)) # (\synthesizer|counter\(0)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001010100010101011000110110001100010101000101010110001101100011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \synthesizer|ALT_INV_counter[3]~DUPLICATE_q\,
...
-- Location: LABCELL_X45_Y58_N57
\synthesizer|Mux8~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|Mux8~0_combout\ = ( \synthesizer|counter[3]~DUPLICATE_q\ & ( (!\synthesizer|counter\(2) & (!\synthesizer|counter\(1) $ (!\synthesizer|counter\(0)))) # (\synthesizer|counter\(2) & ((!\synthesizer|counter\(1)) # (\synthesizer|counter\(0)))) ) ) 
-- # ( !\synthesizer|counter[3]~DUPLICATE_q\ & ( !\synthesizer|counter\(1) $ (((\synthesizer|counter\(0)) # (\synthesizer|counter\(2)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1001001110010011011011010110110110010011100100110110110101101101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \synthesizer|ALT_INV_counter\(2),
	datab => \synthesizer|ALT_INV_counter\(1),
	datac => \synthesizer|ALT_INV_counter\(0),
	datae => \synthesizer|ALT_INV_counter[3]~DUPLICATE_q\,
	combout => \synthesizer|Mux8~0_combout\);

-- Location: FF_X45_Y58_N55
...
-- Location: LABCELL_X45_Y58_N24
\synthesizer|Mux2~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|Mux2~0_combout\ = ( \synthesizer|counter\(0) & ( (!\synthesizer|counter[3]~DUPLICATE_q\ & (\synthesizer|counter\(1))) # (\synthesizer|counter[3]~DUPLICATE_q\ & ((!\synthesizer|counter\(1)) # (\synthesizer|counter\(2)))) ) ) # ( 
-- !\synthesizer|counter\(0) & ( !\synthesizer|counter[3]~DUPLICATE_q\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010101010101010101010101010101001100111011001110110011101100111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \synthesizer|ALT_INV_counter[3]~DUPLICATE_q\,
...
-- Location: LABCELL_X45_Y58_N3
\synthesizer|Mux7~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|Mux7~0_combout\ = ( \synthesizer|counter\(2) & ( (!\synthesizer|counter\(0) & (!\synthesizer|counter[3]~DUPLICATE_q\ $ (!\synthesizer|counter\(1)))) # (\synthesizer|counter\(0) & ((!\synthesizer|counter[3]~DUPLICATE_q\) # 
-- (\synthesizer|counter\(1)))) ) ) # ( !\synthesizer|counter\(2) & ( !\synthesizer|counter[3]~DUPLICATE_q\ $ (((!\synthesizer|counter\(0) & \synthesizer|counter\(1)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111000000111100111100000011110000111100111100110011110011110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \synthesizer|ALT_INV_counter\(0),
	datac => \synthesizer|ALT_INV_counter[3]~DUPLICATE_q\,
	datad => \synthesizer|ALT_INV_counter\(1),
	dataf => \synthesizer|ALT_INV_counter\(2),
	combout => \synthesizer|Mux7~0_combout\);

-- Location: FF_X46_Y58_N13
...
PORT MAP (
	clk => \innerDataClock~q\,
	asdata => \synthesizer|Mux7~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \synthesizer|output_p\(7));

-- Location: LABCELL_X45_Y58_N36
\synthesizer|Mux6~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|Mux6~0_combout\ = ( \synthesizer|counter\(0) & ( (!\synthesizer|counter\(1) & ((\synthesizer|counter[3]~DUPLICATE_q\))) # (\synthesizer|counter\(1) & ((!\synthesizer|counter[3]~DUPLICATE_q\) # (\synthesizer|counter\(2)))) ) ) # ( 
-- !\synthesizer|counter\(0) & ( \synthesizer|counter[3]~DUPLICATE_q\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111100001111000011110000111100111101001111010011110100111101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \synthesizer|ALT_INV_counter\(2),
...
PORT MAP (
	clk => \innerDataClock~q\,
	d => \synthesizer|Mux6~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \synthesizer|output_p\(8));

-- Location: LABCELL_X45_Y58_N27
\synthesizer|Mux1~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|Mux1~0_combout\ = ( \synthesizer|counter\(2) & ( (!\synthesizer|counter[3]~DUPLICATE_q\ & ((!\synthesizer|counter\(1)) # (\synthesizer|counter\(0)))) # (\synthesizer|counter[3]~DUPLICATE_q\ & ((\synthesizer|counter\(1)))) ) ) # ( 
-- !\synthesizer|counter\(2) & ( !\synthesizer|counter[3]~DUPLICATE_q\ $ (((!\synthesizer|counter\(0) & !\synthesizer|counter\(1)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101101010101010010110101010101010101010010111111010101001011111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \synthesizer|ALT_INV_counter[3]~DUPLICATE_q\,
...
PORT MAP (
	clk => \innerDataClock~q\,
	asdata => \synthesizer|Mux1~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \synthesizer|output_p\(9));

-- Location: LABCELL_X45_Y58_N39
\synthesizer|Mux5~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|Mux5~0_combout\ = ( \synthesizer|counter\(0) & ( (!\synthesizer|counter\(1) & ((\synthesizer|counter[3]~DUPLICATE_q\))) # (\synthesizer|counter\(1) & ((!\synthesizer|counter[3]~DUPLICATE_q\) # (\synthesizer|counter\(2)))) ) ) # ( 
-- !\synthesizer|counter\(0) & ( !\synthesizer|counter\(2) $ (!\synthesizer|counter\(1) $ (\synthesizer|counter[3]~DUPLICATE_q\)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0110100101101001011010010110100100111101001111010011110100111101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \synthesizer|ALT_INV_counter\(2),
...
-- Location: LABCELL_X45_Y58_N30
\synthesizer|Mux4~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|Mux4~0_combout\ = ( \synthesizer|counter\(0) & ( (!\synthesizer|counter[3]~DUPLICATE_q\) # ((\synthesizer|counter\(2) & \synthesizer|counter\(1))) ) ) # ( !\synthesizer|counter\(0) & ( \synthesizer|counter[3]~DUPLICATE_q\ ) )
...
-- Location: LABCELL_X45_Y58_N33
\synthesizer|Mux3~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|Mux3~0_combout\ = ( \synthesizer|counter\(0) & ( (!\synthesizer|counter[3]~DUPLICATE_q\) # ((\synthesizer|counter\(2) & \synthesizer|counter\(1))) ) ) # ( !\synthesizer|counter\(0) & ( !\synthesizer|counter[3]~DUPLICATE_q\ ) )
...
PORT MAP (
	clk => \innerDataClock~q\,
	d => \synthesizer|Mux2~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \synthesizer|output_p\(13));

-- Location: FF_X46_Y58_N17
...
-- Location: LABCELL_X45_Y58_N6
\synthesizer|Mux0~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \synthesizer|Mux0~0_combout\ = (!\synthesizer|counter[3]~DUPLICATE_q\ & ((!\synthesizer|counter\(1)) # ((!\synthesizer|counter\(0)) # (!\synthesizer|counter\(2)))))
...
-- Equation(s):
-- \WrReState~0_combout\ = ( !\WrReEn~DUPLICATE_q\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \ALT_INV_WrReEn~DUPLICATE_q\,
...
-- Equation(s):
-- \configurator|stateRegOut[0]~3_combout\ = ( \resetn~input_o\ & ( (\configurator|state.INTER~q\) # (\configurator|state.DISCARD~q\) ) ) # ( !\resetn~input_o\ )
...
-- Equation(s):
-- \configurator|Selector3~0_combout\ = ( \configurator|state.SEND~q\ & ( (!\writeconfig~input_o\ & ((\configurator|state.DONE~q\) # (\configurator|configOK~reg0_q\))) ) ) # ( !\configurator|state.SEND~q\ & ( (\configurator|state.DONE~q\ & 
-- !\writeconfig~input_o\) ) )
...
-- Equation(s):
-- \configurator|nextStateRegOut[0]~4_combout\ = ((!\resetn~input_o\) # (\configurator|nextState.INTER~q\)) # (\configurator|nextState.DISCARD~q\)
...
-- Equation(s):
-- \configurator|nextStateRegOut[1]~5_combout\ = ( \configurator|nextState.SEND~q\ ) # ( !\configurator|nextState.SEND~q\ & ( !\resetn~input_o\ ) )
...
-- Equation(s):
-- \configurator|nextStateRegOut[2]~6_combout\ = ((!\resetn~input_o\) # (\configurator|nextState.DONE~q\)) # (\configurator|nextState.INTER~q\)
...
PORT MAP (
	...
	datad => \configurator|ALT_INV_nextState.DONE~q\,
