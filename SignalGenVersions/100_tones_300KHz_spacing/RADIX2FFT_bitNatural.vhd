-- -------------------------------------------------------------
-- 
-- File Name: /MATLAB Drive/HDLGen/NewSignalGenerator/RADIX2FFT_bitNatural.vhd
...
-- Source Path: NewSignalGenerator/IFFT/RADIX2FFT_bitNatural
-- Hierarchy Level: 2
-- Model version: 1.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF RADIX2FFT_bitNatural IS
  ...
  SIGNAL memOut_im                        : std_logic_vector(40 DOWNTO 0);  -- ufix41
  SIGNAL memOut_im_signed                 : signed(40 DOWNTO 0);  -- sfix41_En20
  SIGNAL memOut_re                        : std_logic_vector(40 DOWNTO 0);  -- ufix41
  SIGNAL memOut_re_signed                 : signed(40 DOWNTO 0);  -- sfix41_En20
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg : signed(40 DOWNTO 0);  -- sfix41
  SIGNAL rdStateMachineBitNatural_doutImReg : signed(40 DOWNTO 0);  -- sfix41
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(40 DOWNTO 0);  -- sfix41_En20
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(40 DOWNTO 0);  -- sfix41_En20
  ...
  SIGNAL dout_re1_tmp                     : signed(40 DOWNTO 0);  -- sfix41_En20
  SIGNAL dout_im1_tmp                     : signed(40 DOWNTO 0);  -- sfix41_En20
...
BEGIN
  ...
  BEGIN
    IF reset = '0' THEN
      ...
      rdStateMachineBitNatural_doutReReg <= to_signed(0, 41);
      rdStateMachineBitNatural_doutImReg <= to_signed(0, 41);
